...
{{--                    @endif--}}
                    ...
                    @endif
                      @if(check_permission('view-withdrawals'))
                        <li class="nav-item"><a class="nav-lin btn btn-success" ONCLICK="show_section($(this))" data-toggle="tab" href="#certifications" role="tab">Certifications</a></li>
                    @endif
...
{{--                                                </div>--}}
                ...
                <div class="tab-pane fade" id="certifications">
                    @include('admin.users.certificitions')
                </div>
...
@endif
            ...
            <div id="fundWithdrawable" class="modal fade">
             ...
             <div id="fundCertifications" class="modal fade">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content tx-size-sm">
                        <div class="modal-header pd-x-20">
                            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Add  {{ $user->name }} fundCertifications</h6>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="{{route('admin.certification.storeuser')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="user_id" value="{{$user->id}}" />
                                                        ...
                                                        <div class="col-12 mt-2 pb-2">
                                                             <section class="col-md-12 border border-light rounded">
                                                                ...
                                                                <select
                                                                    class="form-control"
                                                                    name="id"
                                                                    placeholder = "Selected Certificated"
                                                                >
                                                                    @foreach($certificationsitems as $certificationsitem)
                                                                        <option value="{{$certificationsitem->id}}">{{$certificationsitem->name}} (${{$certificationsitem->amount}})</option>
                                                                    @endforeach
                                                                </select>
                                                            </section>
                                                        </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary">Activate Certificate</button>
                                            </div>
                                        </form>
