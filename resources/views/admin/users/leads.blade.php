                ...
                <div class="br-section-wrapper">
                    ...
                    <form method="POST" action="{{ route('admin.import.leads') }}"  class="restaurant-info-form" enctype="multipart/form-data">
                        ...
                        <div class="d-grid mb-1">
                            ...
                            <a href="{{ asset('csv/lead_import.csv') }}" download="leadd_dwonload.csv" class="btn btn-warning waves-effect waves-float waves-light">Download Template </a>
                        </div>
                    </form>
...
@if(check_permission('create-status-leads'))
            ...
            <div class="row" >
                ...
                <form class="col-10" action="{{ route('admin.users.leads') }}" method="get">
                    <div class="row mb-4">
                      <div class="col-2">
                  ...
                  <form class="col-2" action="{{ route('admin.users.leads') }}" method="get">
                      ...
                      <div class="col-12 d-flex">
                        <select class="form-control" name="sort" style="border-radius: 6px 0px 0px 6px;">
                            ...
                            <label for="submit_form">
                                <option for="submit_form" value="email" @if (Request::get('sort') == "email" ) selected @endif>email</option></label>
                                <option value="source" @if (Request::get('sort') == "source" ) selected @endif>source</option></label>
                                <option value="status" @if (Request::get('sort') == "status" ) selected @endif>status</option></label>
                                <option value="phone" @if (Request::get('sort') == "phone" ) selected @endif>phone</option></label>
                                <option value="manager_id" @if (Request::get('sort') == "manager_id" ) selected @endif>manager</option></label>
                                <option value="created_at" @if (Request::get('sort') == "created_at" ) selected @endif>Date</option></label>
                        </select>
                        <button type="submit" style="border-radius: 0px 6px 6px 0px;background-color:#959694;border-color:#959694;" class="btn btn-primary"><em class="fa fa-filter"></em></button>
                      </div>
