...
@endif
            ...
            <div class="row">
                ...
                <form class="col-10" action="{{ route('admin.users.index') }}" method="get">
                    <div class="row mb-4">
                      <div class="col-2"></div>
                        @if (check_permission('users-update'))
                  ...
                  <form class="col-2" action="{{ route('admin.users.index') }}" method="get">
