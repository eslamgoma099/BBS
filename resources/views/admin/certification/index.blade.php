        ...
        <div class="br-pagebody">
            ...
            <div class="collapse" id="collapseExample">
                <div class="br-section-wrapper">
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Add Certification</h6>

                    <form action="{{ route('admin.certification.store') }}" method="POST" accept-charset="utf-8"
                            ...
                            <div class="row mg-b-25">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mg-b-10-force">
                                        ...
                                        <input class="form-control" step="any" required type="number" name="average"
                                            value="{{ old('average') }}" placeholder="average">
                                    </div>
                                </div>
                            ...
                            @foreach ($certificates as $plan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{!! route('admin.certification.destroy', ['id' => $plan->id]) !!}" accept-charset="UTF-8">
                                            <input name="_method" value="DELETE" type="hidden">
                                            {{ csrf_field() }}

                                            <div class="btn-group justify-center" role="group">
                                                <a href="{{ route('admin.certification.edit', $plan->id) }}"
