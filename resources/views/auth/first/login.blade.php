    ...
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item text-white register">
              <a href="{{ url('joined') }}" class="btn btn-primary btn-md">Sign Up</a>
          </li>
        </ul>
    </div>
  </nav>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form class="form-container" id="form" action="{{ route('login') }}" method="POST" >
                        ...
                        <p class="text-muted text-center">Don't have an account? <a style="font-weight: 300; font-size: 0.9em" href="{{ url('joined') }}" class="text-danger">Register</a></p>
