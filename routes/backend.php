...
Route::group(['middleware' => ['auth','UserActivity','web'], 'prefix' => 'dashboard', 'as' => 'backend.'], function() {
//Route::group(['prefix' => 'dashboard', 'as' => 'backend.'], function() {
    ...
    Route::get('/certificates', [certificatesController::class, 'index'])->name('trade.certificates');
    Route::get('/investment/certificates', [certificatesController::class, 'investmentPlan'])->name('certificates');
    Route::post('/certificates/post', [certificatesController::class, 'store'])->name('certificates.store');
    Route::get('/certificates/setup', [certificatesController::class, 'setup'])->name('certificates.setup');
    Route::get('/activate/{id}', [certificatesController::class, 'activate'])->name('certificates.activate');
    Route::post('/certificates/{id}/upgrade', [certificatesController::class, 'upgrade'])->name('certificates.upgrade');
    //WITHDRAWAL
